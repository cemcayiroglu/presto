...
@Path("/v1/info")
public class RMServerInfoResource
{
    ...
    @Inject
    public RMServerInfoResource(NodeVersion nodeVersion, NodeInfo nodeInfo, ServerConfig serverConfig, GracefulShutdownHandler shutdownHandler)
    {
    ...
    {
        return new ServerInfo(version, environment, coordinator, false, Optional.of(nanosSince(startTime)));
    }
